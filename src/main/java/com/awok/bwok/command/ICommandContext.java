...
/*
Adapted from: https://github.com/duncte123/botCommons
 */
...
public interface ICommandContext {
    ...
    /**
     * Returns the {@link net.dv8tion.jda.api.events.message.GenericMessageEvent message event} that was received for this instance
     *
     * @return the {@link net.dv8tion.jda.api.events.message.GenericMessageEvent message event} that was received for this instance
     */
